...
# D)
Yes, assuming that success in the Hajj lottery only affects outcomes of inducing individuals to undertake the Hajj is critical in order to claim unbiased esimates of $\beta^k$. If winning the Haj lottery caused non-compliance (such as a lottery winner NOT attending the Hajj) then we could no longer assume unbiased estimates. 
